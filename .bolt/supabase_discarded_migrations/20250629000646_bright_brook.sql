...
CREATE TABLE IF NOT EXISTS public.providers (
  ...
  user_id UUID NOT NULL DEFAULT uid() REFERENCES auth.users ON DELETE CASCADE,
...
-- Create audit triggers for important tables (optional - can be enabled as needed)
-- Uncomment these if you want full audit logging:
/*
...
CREATE TRIGGER audit_pre_authorizations
  AFTER INSERT OR UPDATE OR DELETE ON public.pre_authorizations
  FOR EACH ROW EXECUTE FUNCTION public.create_audit_log();
*/
