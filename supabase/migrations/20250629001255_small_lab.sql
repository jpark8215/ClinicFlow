/*
  ...
  1. New Data
    ...
    - Includes patients, providers, appointments, authorizations, etc.
...
-- Insert dummy data using the current authenticated user
DO $$
DECLARE
...
BEGIN
    ...
    -- If no authenticated user, skip the data insertion
    IF current_user_id IS NULL THEN
        RAISE NOTICE 'No authenticated user found. Skipping dummy data insertion.';
        RETURN;
    END IF;
    ...
    RAISE NOTICE 'Successfully inserted dummy data for user: %', current_user_id;
