/*
  # Create Super User Migration

  1. Creates admin@clinicflow.com as a super user
  2. Sets up proper authentication records
  3. Adds helper function to check super admin status
*/
